...
export function HeroSection({
  ...
  return (
    <section className="min-h-[90vh] flex items-center bg-background py-3xl relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[1200px] mx-auto px-lg">
        <div className="flex flex-col md:flex-row gap-2xl items-center">
          ...
          <div className="flex-1 flex flex-col gap-md order-2 md:order-1 text-start">
            ...
            {nameplate && (
              <p className="text-[26px] md:text-[34px] font-semibold text-primary leading-snug">
                {nameplate}
              </p>
            )}
